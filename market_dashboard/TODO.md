...
- [x] **Backtesting Phase 1 — Point-in-time engine** (implement with Sonnet)
...
- [x] **Backtesting Phase 2 — Evaluation module** (implement with Sonnet)
...
- [x] **Backtesting Phase 3 — Report generator** (implement with Sonnet)
...
- [x] **Backtesting Phase 4 — Live performance tracking** (implement with Sonnet)
...
- [x] **Backtesting Phase 5 — Recalibration** (implement with Sonnet)
...
- [x] **Add Global Spillover bucket to model** (implement with Sonnet, precedes Phase 1)
